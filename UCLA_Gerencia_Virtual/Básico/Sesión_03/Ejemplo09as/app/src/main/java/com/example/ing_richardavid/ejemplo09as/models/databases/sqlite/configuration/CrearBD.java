package com.example.ing_richardavid.ejemplo09as.models.databases.sqlite.configuration;
...
import com.example.ing_richardavid.ejemplo09as.models.databases.sqlite.entities.Usuarios;
...
public class CrearBD extends SQLiteOpenHelper {
    ...
    public boolean BuscarUsuario(String usuario, String clave, Vector Usuario) {
        ...
        String[] columnas = new String[] {Usuarios.ID, Usuarios.USUARIO, Usuarios.CLAVE};
